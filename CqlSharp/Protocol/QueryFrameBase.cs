...
namespace CqlSharp.Protocol
{
    internal abstract class QueryFrameBase : Frame
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to skip meta data. If set, the Result Set returned as a response to that query
        /// (if any) will have the NO_METADATA flag
        /// </summary>

...
namespace CqlSharp.Protocol
{
    ...
    public class AuthenticationException : ProtocolException
    {
        ...
        internal AuthenticationException(byte protocolVersion, string message)
            : base(protocolVersion, Protocol.ErrorCode.BadCredentials, message)
        {
        }
        ...
        internal AuthenticationException(byte protocolVersion, string message, Guid? tracingId)
            : base(protocolVersion, Protocol.ErrorCode.BadCredentials, message, tracingId)
        {
        }
    }
}